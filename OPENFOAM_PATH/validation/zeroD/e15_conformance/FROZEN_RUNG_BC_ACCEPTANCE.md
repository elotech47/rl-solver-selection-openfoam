...
| Solver | T₀ [K] | T₁ [K] | ΔT [K] |
|--------|-------:|-------:|-------:|
| CVODE | 800.0000 | 800.0000 | -3.0504e-09 |
| QSS (T-freeze in handoff ODE) | 800.0000 | 800.0000 | -6.8510e-09 |

OF single-step: see E13.1 harness with `Tfreeze true` in qssCoeffs. Re-run with Tfreeze=true via run_e13_1_of.sh after template update if missing.
